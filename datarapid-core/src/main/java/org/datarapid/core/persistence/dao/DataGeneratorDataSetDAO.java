...
/**
 * @Description Generic interface for getting the dataset from the database
 */
public interface DataGeneratorDataSetDAO {

    <T> List<T> listDataSets();

    <T> List<T> getDataSet(String fileName);
