...
public class DataSetConfigurations {
    ...
    /**
     * @return the dataSetConfigurations
     */
    ...
    /**
     * @param dataSetConfigurations the dataSetConfigurations to set
     */
    public void setDataSetConfigurations(List<DataSetConfiguration> dataSetConfigurations) {
